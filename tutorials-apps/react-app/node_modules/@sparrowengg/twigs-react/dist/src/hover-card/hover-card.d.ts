...
declare const StyledHoverCardContent: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<HoverCardPrimitive.HoverCardContentProps & import("react").RefAttributes<HTMLDivElement>>, {}, {
...
export declare const StyledHoverCardArrow: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<HoverCardPrimitive.HoverCardArrowProps & import("react").RefAttributes<SVGSVGElement>>, {}, {
    'screen-xs': "(min-width: 480px)";
    'screen-sm': "(min-width: 640px)";
    'screen-md': "(min-width: 768px)";
    'screen-lg': "(min-width: 1024px)";
...
export declare const HoverCardContent: ({ children, arrow, ...props }: HoverCardContentProps) => JSX.Element;
export {};
