...
export declare const SwitchThumb: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<SwitchPrimitive.SwitchThumbProps & React.RefAttributes<HTMLSpanElement>>, {}, {
    'screen-xs': "(min-width: 480px)";
    'screen-sm': "(min-width: 640px)";
    'screen-md': "(min-width: 768px)";
    'screen-lg': "(min-width: 1024px)";
