...
export declare type FormLabelProps = React.HTMLAttributes<HTMLLabelElement> & {
    as?: React.ElementType;
};
export declare const FormLabel: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<LabelPrimitive.LabelProps & React.RefAttributes<HTMLSpanElement>>, {
