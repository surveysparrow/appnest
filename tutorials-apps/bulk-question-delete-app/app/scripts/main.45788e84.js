...
var App = function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_sparrowengg_twigs_react__WEBPACK_IMPORTED_MODULE_2__.Toastr, {
    duration: 1000,
    position: "top-center",
    css: {
      paddingTop: "$10"
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_sparrowengg_twigs_react__WEBPACK_IMPORTED_MODULE_2__.ThemeProvider, {
    theme: {
      colors: {
        bacground: '#f6f8fa'
      },
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_main__WEBPACK_IMPORTED_MODULE_1__["default"], null)));
};
...
var Main = function Main(props) {
  ...
  var getQuestions = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var allQuestions, pageNo, response, _response, _response2, _error$response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("https://api.surveysparrow.com/v3/questions?page=".concat(pageNo, "&survey_id=").concat(surveyId), {
              headers: {
              ...
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return axios__WEBPACK_IMPORTED_MODULE_8__["default"]["delete"]("https://api.surveysparrow.com/v3/questions/".concat(id), {
                        headers: {
                          Authorization: 'Bearer prTp291Zd5mN5eots8Bio2_eTaUWuvLOGquBfJ3jiAQELSxXnqfVN0H47HFcG5Cpzhgeic-QXknDhIKNpfL_uUGQ'
                        }
                      });
...
//# sourceMappingURL=main.45788e84.js.map